...
#timeclock   ALL=(elasticsearch:elasticsearch) NOPASSWD:ALL
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch start
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch stop
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch status
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch restart
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch condrestart
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch try-restart
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch reload
#timeclock   ALL=(ALL) NOPASSWD: /etc/init.d/elasticsearch force-reload
