...
def set_defaults(canvas_field):
    ...
    :return: None
    """
    current_app.logger.info('set_defaults()')
...
def generate_header(canvas_field):
    ...
    :return: None
    """
    current_app.logger.info('generate_header()')
...
def generate_employee_info(canvas_field):
    ...
    :return:None.
    """
    current_app.logger.info('generate_employee_info()')
...
def generate_timetable(canvas_field, events):
    ...
    :return: None.
    """
    current_app.logger.info('generate_timetable()')
...
def generate_signature_template(canvas_field):
    ...
    :return: None.
    """
    current_app.logger.info('generate_signature_template()')
...
def generate_footer(canvas_field):
    ...
    :return: None.
    """
    current_app.logger.info('generate_footer()')
    canvas_field.setFont('Courier', 8)
