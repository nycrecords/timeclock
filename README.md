...
## Database Setup
TimeClock uses a Postgres database to store and update information. For local development, your TimeClock application will need to connect to an instance of Postgres. To get this set up, we recommend using Docker:
